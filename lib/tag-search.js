...
class Tagged extends React.Component {
	...
	searchTags(search) {
		...
		// add top links
		if(config.topLink) {
			$ul.append('<li class="' + uclass + '" style="' + ustyle + '"><a href="#' + config.topLinkAnchor + '">' + config.topLinkText + '</a></li>');
			$ul2.append('<li class="' + uclass + '" style="' + ustyle + '"><a href="#' + config.topLinkAnchor + '">' + config.topLinkText + '</a></li>');
			allAnchors.append('<li class="' + uclass + '" style="' + ustyle + '"><a href="#' + config.topLinkAnchor + '">' + config.topLinkText + '</a></li>');	
		}
