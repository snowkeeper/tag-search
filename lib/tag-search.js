...
class Tagged extends React.Component {
	...
	searchTags(search) {
		...
		// add top links
		if(config.topLink) {
			$ul.append('<li class="' + liclass + '" style="' + listyle + '"><a  class="' + aclass + '" style="' + astyle + '"href="#' + config.topLinkAnchor + '" >' + config.topLinkText + '</a></li>');
			$ul2.append('<li class="' + liclass + '" style="' + listyle + '"><a  class="' + aclass + '" style="' + astyle + '"href="#' + config.topLinkAnchor + '" >' + config.topLinkText + '</a></li>');
			allAnchors.append('<li class="' + liclass + '" style="' + listyle + '"><a  class="' + aclass + '" style="' + astyle + '"href="#' + config.topLinkAnchor + '" >' + config.topLinkText + '</a></li>');	
		}
		...
		$allAnchors.each(function(k, v) {
			...
			//const context = $anchor.nextUntil(config.contextTextUntilTag).andSelf()
			const $context = $anchor.nextUntil(config.contextTextUntilTag)
			const text = elementsWithSpaces($context)
			const big = isWide ? 150 : 110
			const itemDesc = '<li class="' + liclass + '" style="' + listyle + '"><a  class="' + aclass + '" style="' + astyle + '"href="#' + name + '" >' + nameFromTag + '</a><div class="' + cclass + '" style="' + cstyle + '">' + _.trunc(text, {'length': big,'separator': ' '}) + '</div></li>'
